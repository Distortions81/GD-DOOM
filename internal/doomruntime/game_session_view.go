...
func (g *game) sessionAcknowledgeSaveGame() {
	if g == nil {
		return
	}
	g.saveGameRequested = false
}

func (g *game) sessionAcknowledgeLoadGame() {
	if g == nil {
		return
	}
...
func (g *game) sessionAcknowledgeLevelRestart() {
	if g == nil {
		return
	}
	g.levelRestartRequested = false
}
