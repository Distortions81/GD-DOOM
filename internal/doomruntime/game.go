...
func (g *game) adjustRenderSleepNanosFromInput() {
	if g == nil {
		return
	}
...
func (g *game) sleepRenderStep() {
	if g == nil || g.renderSleepNanos <= 0 {
		return
	}
...
func (g *game) drawDoomBasic3D(screen *ebiten.Image) {
	...
	if screen != nil && screen != g.wallLayer {
