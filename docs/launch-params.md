...
- `-mus-pan-max <0..1>`: limit stereo panning for FM synth music playback.
- `-opl-volume <0..4>`: adjust FM synth output gain.
- `-opl3-backend <auto|impsynth>`: choose the FM synth backend implementation.
